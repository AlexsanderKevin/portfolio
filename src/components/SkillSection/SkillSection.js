...
import { ReactComponent as IconJavascript } from '../../assets/svg/icons/icon-javascript.svg'
import { ReactComponent as IconNode } from '../../assets/svg/icons/icon-node.svg'
import { ReactComponent as IconExpress } from '../../assets/svg/icons/icon-express.svg'
import { ReactComponent as IconReact } from '../../assets/svg/icons/icon-react.svg'
import { ReactComponent as IconSequelize } from '../../assets/svg/icons/icon-sequelize.svg'
import { ReactComponent as IconNpm } from '../../assets/svg/icons/icon-npm.svg'
import { ReactComponent as IconJquery } from '../../assets/svg/icons/icon-jquery.svg'
import { ReactComponent as IconTypescript } from '../../assets/svg/icons/icon-typescript.svg'
import { ReactComponent as IconNext } from '../../assets/svg/icons/icon-next.svg'
import { ReactComponent as IconCss } from '../../assets/svg/icons/icon-css.svg'
import { ReactComponent as IconBootstrap } from '../../assets/svg/icons/icon-bootstrap.svg'
import { ReactComponent as IconSass } from '../../assets/svg/icons/icon-sass.svg'
import { ReactComponent as IconTailwind } from '../../assets/svg/icons/icon-tailwind.svg'
import { ReactComponent as IconHtml } from '../../assets/svg/icons/icon-html.svg'
import { ReactComponent as IconGit } from '../../assets/svg/icons/icon-git.svg'
